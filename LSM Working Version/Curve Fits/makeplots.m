...
subplot(2,1,1)
plot(x1,forceY*10^12,'linewidth',2)
hold on
scatter(d1,force*10^12,100,'o','filled','markeredgecolor','k')
ylabel('Force (pN)')
xlabel('Distance (nm)')
ylim([0 12])
xlim([0 max(d1)])
...
subplot(2,1,2)
plot(x2,energyY*10^3,'linewidth',2)
hold on
scatter(d2,deltaEnergy*10^3,100,'o','filled','markeredgecolor','k')
ylabel('\DeltaE (pN*nm)')
